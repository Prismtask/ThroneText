RACES = {
    ...
    "7": {
        ...
        "elemental_res": {"dark": 1.2, "light": 0.7, "water": 0.8, "magical": 1.1},
        "elemental_dmg": {"fire": 1.3, "dark": 1.2, "magical": 1.2}
    },
    "8": {
        "name": "Dragonborn", "desc": "Proud and resilient with draconic power.",
        "mods": {"Strength": 2, "Constitution": 2, "Charisma": 1, "Dexterity": -1},
        "elemental_res": {"fire": 1.2, "thunder": 1.2, "water": 1.1, "physical": 1.1},
...
CLASSES = {
    ...
    "5": {
        ...
        "elemental_dmg": {"wind": 1.3, "earth": 1.1, "physical": 1.2}
    },
    "6": {
        "name": "Paladin", "desc": "Holy knight sworn to justice.",
        "mods": {"Strength": 2, "Charisma": 2, "Constitution": 1, "Learning": -1},
        "elemental_res": {"dark": 1.2, "fire": 1.1, "light": 1.1, "physical": 1.1},
        "elemental_dmg": {"light": 1.3, "fire": 1.1, "physical": 1.1}
    },
    "7": {
        "name": "Warlock", "desc": "Bargainer with otherworldly powers.",
        "mods": {"Learning": 2, "Charisma": 3, "Constitution": -1, "Wisdom": -1},
        "elemental_res": {"dark": 1.2, "light": 0.8, "magical": 1.2, "physical": 0.8},
        "elemental_dmg": {"dark": 1.3, "fire": 1.1, "magical": 1.3}
    },
    "8": {
        "name": "Barbarian", "desc": "Fierce rage-fueled warrior.",
        "mods": {"Strength": 3, "Constitution": 2, "Dexterity": -1, "Learning": -2},
        "elemental_res": {"wind": 0.8, "fire": 1.1, "physical": 1.2, "magical": 0.8},
        "elemental_dmg": {"fire": 1.3, "earth": 1.2, "physical": 1.3}
    },
}
